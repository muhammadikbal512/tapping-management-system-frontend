...
import { CreateUpdateDialogTypeComponent } from 'src/app/modules/module/channel-configuration/channel-type/widget/create-update-dialog-type/create-update-dialog-type.component';
