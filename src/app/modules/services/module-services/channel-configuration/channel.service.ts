...
import { CreateUpdateDialogChannelComponent } from 'src/app/modules/module/channel-configuration/channel/widget/create-update-dialog/create-update-dialog.component';
